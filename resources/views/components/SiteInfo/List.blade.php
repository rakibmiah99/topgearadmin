    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card animated fadeIn">
            <div class="d-flex align-items-center">
                <h1 class="content-title">Site Info</h1>
...
<script>
    ...
    $('#tableData').on('click','.edit',function (){
        ...
        let id = $(this).attr('data-id');
        axios.post('/SiteInfo/ReadSingle', {
            id: id,
            ...
            if(response.status === 200){
                let data = response.data;
                    ...
                    $('#update-modal #siteType').val(data.type);
                    $('#update-modal #siteDetails').summernote('code',data.details)
            }else{
        ...
        axios.post('/SiteInfo/ReadSingle', {
            ...
            if(response.status === 200){
                ...
                $('#details-modal #show-data').append(`
                    <div class="row">
                        <div class="col-sm-12">
                            <h5 class="text-center"><span class="border-bottom border-2 p-2">${data.type}</span></h5>
                            <div class="template d-flex justify-content-center mt-4">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><span data-id="${item.id}" data-bs-toggle="modal" data-bs-target="#details-modal" class="details dropdown-item text-dark"><i class="fas fa-pen-alt" style="padding-right: 7px;"></i>Details</span></li>
