    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card">
            <div class="d-flex align-items-center">
                <h1 class="content-title">Gallery List</h1>
        ...
        axios.post('/Gallery/ReadSingle', {
            ...
            if(response.status === 200){
                ...
                $('#details-modal #show-data').append(`
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="text-center image p-3">
                                <img src="${data.image}" alt="alt_image" class="img-fluid">
                            </div>
                            <ul class="list-group list-group-flush">
                              <li class="list-group-item"><span class="list-item-header text-center">Title:</span> ${data.title}</li>
