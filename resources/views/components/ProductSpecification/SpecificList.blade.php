    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card">
            <div class="d-flex align-items-center">
                <h1 class="content-title">List Specification dOf {{$productData->title}} ({{$productData->product_code}})</h1>
            ...
            <table id="tableData">
                ...
                <tr class="bg-light">
                    ...
                    <th data-orderable="false">Specification Description</th>
...
<script>
   ...
   CreateTableList();
    ...
    function CreateTableList(){
        ...
        //get seo page data
        axios.post('/ProductSpecification/Read',{productID: $('#productID').val()})
            .then(function (response) {
                if(response.status === 200){
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><span data-id="${item.id}" data-bs-toggle="modal" data-bs-target="#update-modal" class="edit dropdown-item text-dark"><i class="fas fa-pen-alt" style="padding-right: 7px;"></i>Add Specification</span></li>
