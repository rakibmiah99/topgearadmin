    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card animated fadeIn">
            <div class="d-flex align-items-center">
                <h1 class="content-title">Product Brands</h1>
            ...
            <table id="tableData">
                ...
                <tr class="bg-light">
                    ...
                    <th data-orderable="false">Brand Name</th>
...
<script>
    ...
    $('#tableData').on('click','.edit',function (){
        ...
        LoadingModal(loader)
        let id = $(this).attr('data-id');
        axios.post('/ProductBrand/ReadSingle', {
            id: id,
            ...
            if(response.status === 200){
                let data = response.data;
                    ...
                    $('#update-modal #brandName').val(data.brand_name);
            }else{
