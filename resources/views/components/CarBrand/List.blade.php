    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card">
            <div class="d-flex align-items-center">
                <h1 class="content-title">Car Brand</h1>
            ...
            <table id="tableData">
                ...
                <tr class="bg-light">
                    ...
                    <th data-orderable="false">Car Brand</th>
                    <th data-orderable="false">Car Brand Id</th>
...
<script>
    ...
    $('#tableData').on('click','.edit',function (){
        ...
        let id = $(this).attr('data-id');
        //get data to server
        axios.post('/CarBrand/ReadSingle', {
            id: id,
            ...
            if(response.status === 200){
                ...
                $('#update-modal #carBrandName').val(data.car_brand)
                $('#update-modal #carBrandId').val(data.car_brand_id);
            }else{
