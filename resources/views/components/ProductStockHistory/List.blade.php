    ...
    <div class="col-md-12 col-sm-12 col-lg-12">
        <div class="content-card animated fadeIn">
            <div class="d-flex align-items-center">
                <h1 class="content-title">Product Stocked History</h1>
            </div>
            ...
            <table  id="tableData">
                ...
                <tr class="bg-light">
                    ...
                    <th class="text-center" data-orderable="false">Type</th>
                    <th class="text-center" data-orderable="false">Created By</th>
                    <th class="text-center" data-orderable="false">Created Time</th>
...
<script>
    ...
    function CreateTableList(){
        ...
        let stockInBtn = `<button class="btn  btn-primary disabled" style="padding: 3px 12px;font-size: 12px">Stock In</button>`;
        let stockOutBtn = `<button class="btn btn-danger disabled" style="padding: 3px 12px;font-size: 12px">Stock Out</button>`;


        //get seo page data
        axios.get('/ProductStockHistory/Read')
                    ...
                    data.forEach(function(item,index){
                        ...
                        tableList.append(`
                            <tr>
                                ...
                                <td class="text-center">${(item.type === "stock_in") ? stockInBtn : stockOutBtn }</td>
                                <td class="text-center">${item.created_by}</td>
                                <td class="text-center">${moment(item.created_time).format('L')}</td>
